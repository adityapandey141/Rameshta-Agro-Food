...
const SpecialOffers = () => {
  ...
  return (
   <section className="font-sans py-12 sm:py-16 px-4 sm:px-6 md:px-8 lg:px-10 w-full mt-[-80px]">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
    {categories.map((category) => (
      <div key={category.id} className="flex flex-col items-center text-center font-medium">
